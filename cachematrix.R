...
# This is useful for optimizing performance when the inverse is computed multiple times.
...
## It first checks if the inverse is already cached and returns it if available.
